...
// Імена компонентів: PascalCase - перша з великої, для тих які створюємо МИ САМІ
// Вхідні імен, типу констатнт які не змінюються: DB_PASSWORD - у верхньому регистрі, розділяти _ нижнім підкресленням
// всі інші змінні: camelCase
// Назви файлів бажано називати також PascalCase, таким чином імена компонента та файла співпадають
