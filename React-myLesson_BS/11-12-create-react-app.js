 ...
 * Крапка "." вказує директорію де буде встановлений.
 ...
 *
 * Або стоврити в певній папці:
 * * npx create-react-app material-site
 *
...
/**
 * У файлі index.js - <App /> обгорнутий в <React.StrictMode>, це для того, викоистовується для того, щоб виявляти потенційні проблеми в React додатку. Використовується в процесі розробки.
 */
 ...
 *
 * Наступний крок, це запуск команди, щоб Create React App більше не контролювала проект React!
 * * npm run eject
 *
