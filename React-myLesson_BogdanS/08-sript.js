...
const App = ({ initialButtonText, buttonClass }) => {
  ...
  // реструктуризація об'єкт props, або в строці аргументів, що й зробимо
...
// Таке як пропс це об'єкт, то можна зробити деструктьуризацію властивостей props, і далі вже визивати просто як назву змінної, а не через крапковий запис
