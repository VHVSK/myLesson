...
function App() {
  ...
  // Щоб не було затримки, так як ці данні завантажуються через дейкий час, ми створити useState, яка на опчатку приймає null, далі ми отримуємо результат з сервера, далі ми доходимо до функції setTodo, далі реакт баість зміну і знову ререндерить компонент - таким чином відбувається циклічний запит..........
  ...
  // Як ми бачимо, в функції useEffect другим аргументом є масив, це масив залежностей, вын передаэться при визові, і якщо він пустий, ця функція виконується тільки один раз. Тому вона не визивається повторно при житьєвому циклі компонента.
