...
const carInfo = (carObj) => {
  if (carObj.price <= 20000) {
    return `Вартість авто ${carObj.brand} - ${carObj.price}$ і це дешева машина`
  } else if (carObj.price > 20000) {
    return `Цена автомобиля ${carObj.brand} - ${carObj.price}$ і це дорога машина`
  }
